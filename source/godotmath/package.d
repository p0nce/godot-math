...
pure nothrow @nogc @safe:
    ...
    V clamp(const V min, const V max) const => V(gm_clampf(x, min.x, max.x), gm_clampf(y, min.y, max.y));
    V clampf(T min, T max) const => V(gm_clampf(x, min, max), gm_clampf(y, min, max));
    ...
    T length() const => gm_sqrt(x * x + y * y);
...
pure nothrow @nogc @safe:
    ...
    V clamp(const V min, const V max) const 
        => V(gm_clampf(x, min.x, max.x), gm_clampf(y, min.y, max.y), gm_clampf(z, min.z, max.z));
    V clampf(T min, T max) const 
        => V(gm_clampf(x, min, max), gm_clampf(y, min, max), gm_clampf(z, min, max));
    ...
    T length() const => gm_sqrt(x * x + y * y + z * z);
